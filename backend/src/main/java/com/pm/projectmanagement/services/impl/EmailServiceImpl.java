        ...
        try {
            ...
            String htmlContent =
                    "<div style='font-family: Arial, sans-serif; max-width: 600px; margin: auto;'>"
                            ...
                            + "A task has been updated by a team member. Here are the details:</p>"

                            + "<div style='background: #fff; border: 1px solid #e5e5e5; border-radius: 8px; padding: 20px;'>"

                            + "<div style='margin-bottom: 14px;'>"
                            + "<span style='font-size: 11px; color: #999; text-transform: uppercase; letter-spacing: 0.5px;'>Task</span>"
                            ...
                            + " <span style='color: #999;'>(" + changedBy.getEmail() + ")</span>"
                            + "</p>"
                            + "</div>"
                            ...
                            + "Please login to review and take action if needed.</p>"
                            + "</div>"
                            ...
                            + "<p style='color: #aaa; font-size: 11px; margin: 0;'>Project Management System &nbsp;|&nbsp; Automated Notification</p>"
                            + "</div>"
