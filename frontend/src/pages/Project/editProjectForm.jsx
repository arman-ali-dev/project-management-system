...
const inputClass =
    "border-[#BCBCBC] w-full outline-0 px-4 py-2 text-[15px] mt-1 border rounded-sm transition-all duration-200 focus:border-black focus:shadow-[0_0_0_2px_rgba(0,0,0,0.08)]";
...
const projectValidationSchema = Yup.object( {
    ...
    members: Yup.array()
        .required()
        .min( 1, "At least one member must be included." ),
} );
                                    ...
                                    <img
                                        ...
                                        onClick={ () =>
                                            formik.setFieldValue(
                                                "members",
                                                formik.values.members.filter( ( u ) => u.id !== user.id ),
                                            )
                                        }
                                    />
                                </div>
                        ...
                        <Button
                            ...
                            sx={ {
                                ...
                                "&:hover": {
                                    ...
                                    transform: "translateY(-1px) !important",
                                    boxShadow: "0 4px 14px rgba(0,0,0,0.2) !important",
                                },
                                "&:active": { transform: "scale(0.97) !important" },
                            } }
                        >
